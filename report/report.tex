...
\subfloat[Input Scene]{
	\includegraphics[bb=80bp 80bp 460bp 500bp,clip,scale=0.2]{figures/3_points_input.png}
	\label{3_points_input}}
\subfloat[Reconstructed Image]{
	\includegraphics[bb=100bp 100bp 600bp 600bp,clip,scale=0.2]{figures/3_points.png}
...
\subfloat[Input Scene]{
	\includegraphics[bb=80bp 80bp 460bp 500bp,clip,scale=0.2]{figures/sphere_input.png}
	\label{sphere_input}}
\subfloat[Reconstructed Image]{
...
\subfloat[]{
	\includegraphics[bb=80bp 80bp 460bp 500bp,clip,scale=0.2]{figures/skull4.png}
	\label{skull_angle1}}
\subfloat[]{
	\includegraphics[bb=100bp 100bp 600bp 600bp,clip,scale=0.2]{figures/skull6.png}
	\label{skull_angle2}}
...
The simulated events include:
1. pkt send
2. pkt head and tail receive
3. pkt acks and retries
4. buffer full and empty events

Worked by having event queue for each node. Whenever comm occurred between neighbors, appropriate event added to queues for both nodes.
...
Simulator allowed effect of bandwidth, array size, latency and amount of precomputation on performance (framerate, cpu util and memory usage) to be determined. Also allows number of difference comm patterns to be investigated. Figure~\ref{comm_patterns_arrows} shows the different patterns that were investigated. Green arrows shows movement of data before alg starts. Red shows where data is located at end of computation.
