...
Describe the row-wise transpose.
...
Same as row-wise transpose, except that processors in same column communicate. After comm, processors in 1st row have 1st freq value, 2nd row have 2nd.

\begin{figure}[!h]
\centering
\includegraphics*[width=0.5\textwidth, viewport = 10 10 620 150]{figures/column_wise_transpose.pdf}
